...
def homepage(request):
    ...
    try:
        ...
        return render(request, 'magazine//welcome_homepage_view.html', {'issue': earliest_approved_issue})
    ...
    if (datetime.now().replace(tzinfo=utc) - last_published_issue.status_changed_at.replace(tzinfo=utc)).days   > 14:
        ...
        if earliest_approved_issue is None:
            ...
            return render(request, 'magazine//welcome_homepage_view.html', {'issue': last_published_issue})
